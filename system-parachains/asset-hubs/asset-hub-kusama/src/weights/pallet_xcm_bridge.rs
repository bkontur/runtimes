...
impl<T: frame_system::Config> pallet_xcm_bridge::WeightInfo for WeightInfo<T> {
	...
	/// Storage: `XcmOverAssetHubPolkadot::Bridges` (r:1 w:1)
	/// Proof: `XcmOverAssetHubPolkadot::Bridges` (`max_values`: None, `max_size`: Some(1922), added: 4397, mode: `MaxEncodedLen`)
	/// Storage: `XcmOverAssetHubPolkadot::LaneToBridge` (r:1 w:1)
	/// Proof: `XcmOverAssetHubPolkadot::LaneToBridge` (`max_values`: None, `max_size`: Some(64), added: 2539, mode: `MaxEncodedLen`)
	/// Storage: `BridgePolkadotMessages::InboundLanes` (r:1 w:1)
	/// Proof: `BridgePolkadotMessages::InboundLanes` (`max_values`: None, `max_size`: Some(49208), added: 51683, mode: `MaxEncodedLen`)
	...
	/// Storage: `BridgePolkadotMessages::OutboundLanes` (r:1 w:1)
	/// Proof: `BridgePolkadotMessages::OutboundLanes` (`max_values`: None, `max_size`: Some(73), added: 2548, mode: `MaxEncodedLen`)
	/// Storage: `XcmOverAssetHubPolkadot::LaneToBridge` (r:0 w:1)
	/// Proof: `XcmOverAssetHubPolkadot::LaneToBridge` (`max_values`: None, `max_size`: Some(64), added: 2539, mode: `MaxEncodedLen`)
