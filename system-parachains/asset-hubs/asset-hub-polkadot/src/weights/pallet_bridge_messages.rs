...
// --chain=bridge-hub-polkadot-dev TODO: FAIL-CI regenerate
...
impl<T: frame_system::Config> pallet_bridge_messages::WeightInfo for WeightInfo<T> {
	...
	/// Proof: `XcmOverBridgeHubPolkadot::Bridges` (`max_values`: None, `max_size`: Some(1893), added: 4368, mode: `MaxEncodedLen`)
	...
	/// Proof: `XcmOverBridgeHubKusama::Bridges` (`max_values`: None, `max_size`: Some(1893), added: 4368, mode: `MaxEncodedLen`)
