...
impl<T: frame_system::Config> pallet_bulletin_transaction_storage::WeightInfo for WeightInfo<T> {
	...
	// PROVISIONAL: taken from the bulletin-westend reference weights, which were benchmarked
	// against the post-split pallet. Re-run the benchmarks for this runtime before release.
